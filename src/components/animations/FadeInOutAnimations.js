...
const FadeInOutAnimations = (props) => {
  ...
  useEffect(() => {
    Animated.sequence([
      Animated.timing(fadeInOutAnimation, { toValue: 1, duration: 500, useNativeDriver: true }),
      Animated.timing(fadeInOutAnimation, { toValue: 0, duration: 500, useNativeDriver: true }),
      Animated.timing(fadeInOutAnimation, { toValue: 1, duration: 500, useNativeDriver: true }),
